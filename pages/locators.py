...
class BasePageLocators:
    ...
    LOGIN_LINK_INVALID = (By.CSS_SELECTOR, "#login_link_wrong")
...
class ProductPageLocators:
    GOOD = (By.CSS_SELECTOR, ".product_main h1") #название книги
    PRICE = (By.CSS_SELECTOR, "p.price_color") 
    SUCCESS_MESSAGE = (By.CSS_SELECTOR, "div.alertinner")
    ADDING_GOODS_TO_BASKET = (By.CSS_SELECTOR, ".btn-add-to-basket") #css кнопка добавить в корзину
